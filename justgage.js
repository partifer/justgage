 ...
 * -----------------------------
 ...
 JustGage = function(config) {
  ...
  else if( obj.config.textRenderer ) obj.txtMinimum = obj.config.textRenderer( obj.config.min);
  ...
  else if( obj.config.textRenderer ) obj.txtMaximum = obj.config.textRenderer( obj.config.max );
